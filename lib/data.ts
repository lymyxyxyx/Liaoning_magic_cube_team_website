...
export const competitionCategories: CompetitionCategory[] = [
  ...
  },
  {
    ...
    name: "中国魔方运动巡回赛（国赛）",
    shortName: "国赛",
    description: "国家体育总局棋牌运动管理中心体系的中国魔方运动巡回赛及总决赛。"
  },
  {
    id: "weekly-meet",
    name: "辽宁魔方少儿战队周赛",
    shortName: "周赛",
    description: "辽宁魔方少儿战队队内周赛、阶段成绩与周赛总结。"
  },
  {
    id: "wca-official",
    name: "WCA",
...
const wcaLiaoningCompetitions: Competition[] = [
  {
    id: "c-wca-shenyang-cubing-league-3x3-iv-2026",
    slug: "wca-shenyang-cubing-league-3x3-iv-2026",
    name: "2026WCA沈阳三阶魔方联赛IV",
    category: "wca-official",
    date: "2026-07-08",
    province: "辽宁",
    city: "沈阳",
    venue: "浑南中路28号辽宁省浑南体育训练基地游泳网球中心一楼培训室",
    address: "辽宁省沈阳市浑南中路28号辽宁省浑南体育训练基地游泳网球中心一楼培训室",
    tags: ["WCA", "沈阳", "三阶联赛"],
    cover: "/visuals/event-shenyang.svg",
    externalUrl: "https://cubing.com/competition/Shenyang-Cubing-League-3x3-IV-2026",
    summary: "WCA 辽宁赛事记录。",
    description: "依据粗饼辽宁省赛事列表整理，后续可继续补充项目、成绩和相关人员。",
    status: "待补充",
    completeness: "低",
    featured: false
  },
  {
    id: "c-wca-shenyang-cubing-league-3x3-iii-2026",
    slug: "wca-shenyang-cubing-league-3x3-iii-2026",
    name: "2026WCA沈阳三阶魔方联赛III",
    category: "wca-official",
    date: "2026-07-01",
    province: "辽宁",
    city: "沈阳",
    ...
    tags: ["WCA", "沈阳", "三阶联赛"],
    cover: "/visuals/event-shenyang.svg",
    externalUrl: "https://cubing.com/competition/Shenyang-Cubing-League-3x3-III-2026",
    summary: "WCA 辽宁赛事记录。",
    description: "依据粗饼辽宁省赛事列表整理，后续可继续补充项目、成绩和相关人员。",
    status: "待补充",
    completeness: "低",
  ...
  {
    id: "c-wca-shenyang-cubing-league-3x3-ii-2026",
    slug: "wca-shenyang-cubing-league-3x3-ii-2026",
    name: "2026WCA沈阳三阶魔方联赛II",
    category: "wca-official",
    date: "2026-06-24",
    province: "辽宁",
    city: "沈阳",
    ...
    tags: ["WCA", "沈阳", "三阶联赛"],
    cover: "/visuals/event-shenyang.svg",
    externalUrl: "https://cubing.com/competition/Shenyang-Cubing-League-3x3-II-2026",
    summary: "WCA 辽宁赛事记录。",
    description: "依据粗饼辽宁省赛事列表整理，后续可继续补充项目、成绩和相关人员。",
    status: "待补充",
    completeness: "低",
  ...
  {
    id: "c-wca-shenyang-cubing-league-3x3-i-2026",
    slug: "wca-shenyang-cubing-league-3x3-i-2026",
    name: "2026WCA沈阳三阶魔方联赛I",
    category: "wca-official",
    date: "2026-06-17",
    province: "辽宁",
    city: "沈阳",
    ...
    tags: ["WCA", "沈阳", "三阶联赛"],
    cover: "/visuals/event-shenyang.svg",
    externalUrl: "https://cubing.com/competition/Shenyang-Cubing-League-3x3-I-2026",
    summary: "WCA 辽宁赛事记录。",
    description: "依据粗饼辽宁省赛事列表整理，后续可继续补充项目、成绩和相关人员。",
    status: "待补充",
    completeness: "低",
  ...
  },
  {
    ...
    tags: ["WCA", "最少步", "沈阳"],
    cover: "/visuals/event-shenyang.svg",
    externalUrl: "https://cubing.com/competition/FMC-Cubing-China-2025",
    summary: "WCA 辽宁赛事记录。",
  ...
  },
  {
    ...
    tags: ["WCA", "沈阳"],
    cover: "/visuals/event-shenyang.svg",
    externalUrl: "https://cubing.com/competition/Shenyang-Autumn-2025",
    summary: "WCA 辽宁赛事记录。",
    description: "依据 WCA 辽宁赛事列表整理，后续可继续补充项目、成绩和相关人员。",
    status: "部分整理",
    completeness: "中",
  ...
  },
  {
    ...
    tags: ["WCA", "沈阳"],
    cover: "/visuals/event-shenyang.svg",
    externalUrl: "https://cubing.com/competition/Shenyang-Spring-2025",
    summary: "WCA 辽宁赛事记录。",
    description: "依据 WCA 辽宁赛事列表整理，后续可继续补充项目、成绩和相关人员。",
    status: "部分整理",
    completeness: "中",
  ...
  },
  {
    ...
    externalUrl: "https://cubing.com/competition/Dalian-Open-2024",
    summary: "WCA 辽宁赛事记录。",
    description: "依据 WCA 辽宁赛事列表整理，后续可继续补充项目、成绩和相关人员。",
    status: "部分整理",
    completeness: "中",
  ...
  },
  {
    ...
    externalUrl: "https://cubing.com/competition/Dandong-Yalu-River-Open-2024",
    summary: "WCA 辽宁赛事记录。",
    description: "依据 WCA 辽宁赛事列表整理，后续可继续补充项目、成绩和相关人员。",
    status: "部分整理",
    completeness: "中",
  ...
  },
  {
    ...
    tags: ["WCA", "沈阳"],
    cover: "/visuals/event-shenyang.svg",
    externalUrl: "https://cubing.com/competition/Shenyang-Spring-2024",
    summary: "WCA 辽宁赛事记录。",
    description: "依据 WCA 辽宁赛事列表整理，后续可继续补充项目、成绩和相关人员。",
    status: "部分整理",
    completeness: "中",
  ...
  },
  {
    ...
    tags: ["WCA", "抚顺"],
    cover: "/visuals/event-anshan.svg",
    externalUrl: "https://cubing.com/competition/Fushun-Open-2024",
    summary: "WCA 辽宁赛事记录。",
    description: "依据 WCA 辽宁赛事列表整理，后续可继续补充项目、成绩和相关人员。",
    status: "部分整理",
    completeness: "中",
  ...
  },
  {
    ...
    tags: ["WCA", "沈阳"],
    cover: "/visuals/event-shenyang.svg",
    externalUrl: "https://cubing.com/competition/Shenyang-Open-2023",
    summary: "WCA 辽宁赛事记录。",
    description: "依据 WCA 辽宁赛事列表整理，后续可继续补充项目、成绩和相关人员。",
    status: "部分整理",
    completeness: "中",
  ...
  },
  {
    ...
    city: "抚顺",
    venue: "待补充",
    address: "辽宁省抚顺市（地点待补充）",
    tags: ["WCA", "抚顺"],
    cover: "/visuals/event-anshan.svg",
    externalUrl: "https://cubing.com/competition/Fushun-Open-2020",
    summary: "WCA 辽宁赛事记录。",
    description: "依据 WCA 辽宁赛事列表整理，后续可继续补充项目、成绩和相关人员。",
    status: "待补充",
    completeness: "低",
  ...
  },
  {
    ...
    tags: ["WCA", "沈阳"],
    cover: "/visuals/event-shenyang.svg",
    externalUrl: "https://cubing.com/competition/NEU-Open-2019",
    summary: "WCA 辽宁赛事记录。",
    description: "依据 WCA 辽宁赛事列表整理，后续可继续补充项目、成绩和相关人员。",
    status: "部分整理",
    completeness: "中",
  ...
  },
  {
    ...
    tags: ["WCA", "沈阳"],
    cover: "/visuals/event-shenyang.svg",
    externalUrl: "https://cubing.com/competition/Shenyang-Open-2019",
    summary: "WCA 辽宁赛事记录。",
    description: "依据 WCA 辽宁赛事列表整理，后续可继续补充项目、成绩和相关人员。",
    status: "部分整理",
    completeness: "中",
  ...
  },
  {
    ...
    tags: ["WCA", "大连"],
    cover: "/visuals/event-dalian.svg",
    externalUrl: "https://cubing.com/competition/Dalian-Spring-2019",
    summary: "WCA 辽宁赛事记录。",
    description: "依据 WCA 辽宁赛事列表整理，后续可继续补充项目、成绩和相关人员。",
    status: "部分整理",
    completeness: "中",
  ...
  },
  {
    ...
    tags: ["WCA", "沈阳"],
    cover: "/visuals/event-shenyang.svg",
    externalUrl: "https://cubing.com/competition/Shenyang-New-Year-2019",
    summary: "WCA 辽宁赛事记录。",
    description: "依据 WCA 辽宁赛事列表整理，后续可继续补充项目、成绩和相关人员。",
    status: "部分整理",
    completeness: "中",
  ...
  },
  {
    ...
    tags: ["WCA", "沈阳"],
    cover: "/visuals/event-shenyang.svg",
    externalUrl: "https://cubing.com/competition/Shenyang-Summer-2018",
    summary: "WCA 辽宁赛事记录。",
    description: "依据 WCA 辽宁赛事列表整理，后续可继续补充项目、成绩和相关人员。",
    status: "部分整理",
    completeness: "中",
  ...
  },
  {
    ...
    tags: ["WCA", "最少步", "沈阳"],
    cover: "/visuals/event-shenyang.svg",
    externalUrl: "https://cubing.com/competition/Cross-strait-FMC-2018",
    summary: "WCA 辽宁赛事记录。",
    description: "依据 WCA 辽宁赛事列表整理，后续可继续补充项目、成绩和相关人员。",
    status: "部分整理",
    completeness: "中",
  ...
  },
  {
    ...
    tags: ["WCA", "沈阳"],
    cover: "/visuals/event-shenyang.svg",
    externalUrl: "https://cubing.com/competition/Shenyang-Open-2018",
    summary: "WCA 辽宁赛事记录。",
    description: "依据 WCA 辽宁赛事列表整理，后续可继续补充项目、成绩和相关人员。",
    status: "部分整理",
    completeness: "中",
  ...
  },
  {
    ...
    tags: ["WCA", "大连"],
    cover: "/visuals/event-dalian.svg",
    externalUrl: "https://cubing.com/competition/Dalin-Open-2018",
    summary: "WCA 辽宁赛事记录。",
    description: "依据 WCA 辽宁赛事列表整理，后续可继续补充项目、成绩和相关人员。",
    status: "部分整理",
    completeness: "中",
  ...
  },
  {
    ...
    tags: ["WCA", "抚顺"],
    cover: "/visuals/event-anshan.svg",
    externalUrl: "https://cubing.com/competition/Fushun-Open-2018",
    summary: "WCA 辽宁赛事记录。",
    description: "依据 WCA 辽宁赛事列表整理，后续可继续补充项目、成绩和相关人员。",
    status: "部分整理",
    completeness: "中",
  ...
  },
  {
    ...
    tags: ["WCA", "大连"],
    cover: "/visuals/event-dalian.svg",
    externalUrl: "https://cubing.com/competition/Dalian-Winter-2017",
    summary: "WCA 辽宁赛事记录。",
    description: "依据 WCA 辽宁赛事列表整理，后续可继续补充项目、成绩和相关人员。",
    status: "部分整理",
    completeness: "中",
  ...
  },
  {
    ...
    tags: ["WCA", "沈阳"],
    cover: "/visuals/event-shenyang.svg",
    externalUrl: "https://cubing.com/competition/Shenyang-Spring-2017",
    summary: "WCA 辽宁赛事记录。",
    description: "依据 WCA 辽宁赛事列表整理，后续可继续补充项目、成绩和相关人员。",
    status: "部分整理",
    completeness: "中",
  ...
  },
  {
    ...
    tags: ["WCA", "沈阳"],
    cover: "/visuals/event-shenyang.svg",
    externalUrl: "https://cubing.com/competition/Shenyang-Winter-2016",
    summary: "WCA 辽宁赛事记录。",
    description: "依据 WCA 辽宁赛事列表整理，后续可继续补充项目、成绩和相关人员。",
    status: "部分整理",
    completeness: "中",
  ...
  },
  {
    ...
    tags: ["WCA", "最少步", "沈阳"],
    cover: "/visuals/event-shenyang.svg",
    externalUrl: "https://cubing.com/competition/FMC-Asia-2016",
    summary: "WCA 辽宁赛事记录。",
    description: "依据 WCA 辽宁赛事列表整理，后续可继续补充项目、成绩和相关人员。",
    status: "部分整理",
    completeness: "中",
  ...
  },
  {
    ...
    tags: ["WCA", "沈阳"],
    cover: "/visuals/event-shenyang.svg",
    externalUrl: "https://cubing.com/competition/Shenyang-Open-2016",
    summary: "WCA 辽宁赛事记录。",
    description: "依据 WCA 辽宁赛事列表整理，后续可继续补充项目、成绩和相关人员。",
    status: "部分整理",
    completeness: "中",
  ...
  },
  {
    ...
    tags: ["WCA", "大连"],
    cover: "/visuals/event-dalian.svg",
    externalUrl: "https://cubing.com/competition/Dalian-Open-2015",
    summary: "WCA 辽宁赛事记录。",
    description: "依据 WCA 辽宁赛事列表整理，后续可继续补充项目、成绩和相关人员。",
    status: "部分整理",
    completeness: "中",
  ...
  },
  {
    ...
    tags: ["WCA", "沈阳"],
    cover: "/visuals/event-shenyang.svg",
    externalUrl: "https://cubing.com/competition/Shenyang-Open-2014",
    summary: "WCA 辽宁赛事记录。",
    description: "依据 WCA 辽宁赛事列表整理，后续可继续补充项目、成绩和相关人员。",
    status: "部分整理",
    completeness: "中",
  ...
  },
  {
    ...
    tags: ["WCA", "沈阳"],
    cover: "/visuals/event-shenyang.svg",
    externalUrl: "https://cubing.com/competition/Shenyang-Open-2013",
    summary: "WCA 辽宁赛事记录。",
    description: "依据 WCA 辽宁赛事列表整理，后续可继续补充项目、成绩和相关人员。",
    status: "部分整理",
    completeness: "中",
  ...
  },
  {
    ...
    tags: ["WCA", "大连"],
    cover: "/visuals/event-dalian.svg",
    externalUrl: "https://cubing.com/competition/Dalian-Open-2013",
    summary: "WCA 辽宁赛事记录。",
    description: "依据 WCA 辽宁赛事列表整理，后续可继续补充项目、成绩和相关人员。",
    status: "部分整理",
    completeness: "中",
  ...
  },
  {
    ...
    tags: ["WCA", "营口"],
    cover: "/visuals/event-anshan.svg",
    externalUrl: "https://cubing.com/competition/Yingkou-Open-2013",
    summary: "WCA 辽宁赛事记录。",
    description: "依据 WCA 辽宁赛事列表整理，后续可继续补充项目、成绩和相关人员。",
    status: "部分整理",
    completeness: "中",
  ...
  },
  {
    ...
    tags: ["WCA", "最少步", "沈阳"],
    cover: "/visuals/event-shenyang.svg",
    externalUrl: "https://cubing.com/competition/China-FM-2011-Shenyang",
    summary: "WCA 辽宁赛事记录。",
    description: "依据 WCA 辽宁赛事列表整理，后续可继续补充项目、成绩和相关人员。",
    status: "部分整理",
    completeness: "中",
  ...
  },
  {
    ...
    tags: ["WCA", "沈阳"],
    cover: "/visuals/event-shenyang.svg",
    externalUrl: "https://cubing.com/competition/ShenYang-Open-2011",
    summary: "WCA 辽宁赛事记录。",
    description: "依据 WCA 辽宁赛事列表整理，后续可继续补充项目、成绩和相关人员。",
    status: "部分整理",
    completeness: "中",
  ...
  },
  {
    ...
    tags: ["WCA", "营口"],
    cover: "/visuals/event-anshan.svg",
    externalUrl: "https://cubing.com/competition/Yingkou-Open-2011",
    summary: "WCA 辽宁赛事记录。",
    description: "依据 WCA 辽宁赛事列表整理，后续可继续补充项目、成绩和相关人员。",
    status: "部分整理",
    completeness: "中",
  ...
  },
  {
    ...
    tags: ["WCA", "沈阳"],
    cover: "/visuals/event-shenyang.svg",
    externalUrl: "https://cubing.com/competition/Shenyang-Cubing-Boxing-Day-2010",
    summary: "WCA 辽宁赛事记录。",
    description: "依据 WCA 辽宁赛事列表整理，后续可继续补充项目、成绩和相关人员。",
    status: "部分整理",
    completeness: "中",
  ...
  },
  {
    ...
    tags: ["WCA", "沈阳"],
    cover: "/visuals/event-shenyang.svg",
    externalUrl: "https://cubing.com/competition/Duanwu-Festival-Open-2009",
    summary: "WCA 辽宁赛事记录。",
    description: "依据 WCA 辽宁赛事列表整理，后续可继续补充项目、成绩和相关人员。",
    status: "部分整理",
    completeness: "中",
...
const nationalTourCompetitions: Competition[] = [
  {
    id: "c-national-tour-yancheng-2026",
    slug: "national-tour-yancheng-2026",
    name: "2026年中国魔方运动巡回赛暨段级位积分赛（盐城站）",
    category: "national-tour",
    date: "2026-04-18~19",
    province: "江苏",
    city: "盐城",
    venue: "待补充",
    address: "江苏省盐城市（场馆待补充）",
    tags: ["国赛", "分站赛", "巡回赛"],
    cover: "/visuals/event-shenyang.svg",
    dataSource: "国赛专题",
    dataSourceUrl: "/national-events",
    publicPlatform: "站内专题",
    publicMethod: "查看晋级名单/成绩",
    externalUrl: "/national-events/qualifiers",
    summary: "2026年中国魔方运动巡回赛第一站。",
    description: "2026年中国魔方运动巡回赛暨段级位积分赛第一站，站内已整理晋级名单与成绩入口。",
    status: "已整理",
    completeness: "中",
    featured: false
  },
  {
    id: "c-national-tour-loudi-2026",
    slug: "national-tour-loudi-2026",
    name: "2026年中国魔方运动巡回赛暨段级位积分赛（娄底站）",
    category: "national-tour",
    date: "2026-05-03~04",
    province: "湖南",
    city: "娄底",
    venue: "待补充",
    address: "湖南省娄底市（场馆待补充）",
    tags: ["国赛", "分站赛", "巡回赛"],
    cover: "/visuals/event-shenyang.svg",
    dataSource: "国赛专题",
    dataSourceUrl: "/national-events",
    publicPlatform: "站内专题",
    publicMethod: "查看成绩",
    externalUrl: "/national-events/results?station=second",
    summary: "2026年中国魔方运动巡回赛第二站。",
    description: "2026年中国魔方运动巡回赛暨段级位积分赛第二站，站内已整理成绩入口。",
    status: "已整理",
    completeness: "中",
    featured: false
  },
  {
    id: "c-national-tour-lishui-2026",
    slug: "national-tour-lishui-2026",
    name: "2026年中国魔方运动巡回赛暨段级位积分赛（丽水站）",
    category: "national-tour",
    date: "2026-06-13~14",
    province: "浙江",
    city: "丽水",
    venue: "待补充",
    address: "浙江省丽水市（场馆待补充）",
    tags: ["国赛", "分站赛", "巡回赛"],
    cover: "/visuals/event-shenyang.svg",
    dataSource: "国赛专题",
    dataSourceUrl: "/national-events",
    publicPlatform: "站内专题",
    publicMethod: "查看专题",
    externalUrl: "/national-events",
    summary: "2026年中国魔方运动巡回赛第三站。",
    description: "2026年中国魔方运动巡回赛暨段级位积分赛第三站，后续可继续补充各站成绩与辽宁选手参赛记录。",
    status: "部分整理",
    completeness: "中",
    featured: false
  },
  {
    id: "c-national-tour-tianchang-2026",
    slug: "national-tour-tianchang-2026",
    name: "2026年中国魔方运动巡回赛暨段级位积分赛（天长站）",
    category: "national-tour",
    date: "2026-06-27~28",
    province: "安徽",
    city: "天长",
    venue: "待补充",
    address: "安徽省天长市（场馆待补充）",
    tags: ["国赛", "分站赛", "巡回赛"],
    cover: "/visuals/event-shenyang.svg",
    dataSource: "国赛专题",
    dataSourceUrl: "/national-events",
    ...
    publicMethod: "查看专题",
    externalUrl: "/national-events",
    summary: "2026年中国魔方运动巡回赛第四站。",
    description: "2026年中国魔方运动巡回赛暨段级位积分赛第四站，后续可继续补充各站成绩与辽宁选手参赛记录。",
    status: "部分整理",
    completeness: "中",
    featured: false
  },
  {
    id: "c-national-tour-fuping-2026",
    slug: "national-tour-fuping-2026",
    name: "2026年中国魔方运动巡回赛暨段级位积分赛（富平站）",
    category: "national-tour",
    date: "2026-07-25~26",
    province: "陕西",
    city: "富平",
    venue: "待补充",
    address: "陕西省富平县（场馆待补充）",
    tags: ["国赛", "分站赛", "巡回赛"],
    cover: "/visuals/event-shenyang.svg",
    dataSource: "国赛专题",
    dataSourceUrl: "/national-events",
    ...
    publicMethod: "查看专题",
    externalUrl: "/national-events",
    summary: "2026年中国魔方运动巡回赛第五站。",
    description: "2026年中国魔方运动巡回赛暨段级位积分赛第五站，后续可继续补充各站成绩与辽宁选手参赛记录。",
    status: "部分整理",
    completeness: "中",
    featured: false
  },
  {
    id: "c-national-tour-putian-2026",
    slug: "national-tour-putian-2026",
    name: "2026年中国魔方运动巡回赛暨段级位积分赛（莆田站）",
    category: "national-tour",
    date: "2026-09-12~13",
    province: "福建",
    city: "莆田",
    venue: "待补充",
    address: "福建省莆田市（场馆待补充）",
    tags: ["国赛", "分站赛", "巡回赛"],
    cover: "/visuals/event-shenyang.svg",
    dataSource: "国赛专题",
    dataSourceUrl: "/national-events",
    ...
    publicMethod: "查看专题",
    externalUrl: "/national-events",
    summary: "2026年中国魔方运动巡回赛第六站。",
    description: "2026年中国魔方运动巡回赛暨段级位积分赛第六站，后续可继续补充各站成绩与辽宁选手参赛记录。",
    status: "部分整理",
    completeness: "中",
    featured: false
  },
  {
    id: "c-national-tour-suizhou-2026",
    slug: "national-tour-suizhou-2026",
    name: "2026年中国魔方运动巡回赛暨段级位积分赛（随州站）",
    category: "national-tour",
    date: "2026-10-31~11-01",
    province: "湖北",
    city: "随州",
    venue: "待补充",
    address: "湖北省随州市（场馆待补充）",
    tags: ["国赛", "分站赛", "巡回赛"],
    cover: "/visuals/event-shenyang.svg",
    dataSource: "国赛专题",
    dataSourceUrl: "/national-events",
    ...
    publicMethod: "查看专题",
    externalUrl: "/national-events",
    summary: "2026年中国魔方运动巡回赛第七站。",
    description: "2026年中国魔方运动巡回赛暨段级位积分赛第七站，后续可继续补充各站成绩与辽宁选手参赛记录。",
    status: "部分整理",
    completeness: "中",
    featured: false
  },
  {
    id: "c-national-tour-finals-2026",
    slug: "national-tour-finals-2026",
    name: "2026年中国魔方运动巡回赛暨段级位积分赛总决赛",
    category: "national-tour",
    date: "2026-11-27~29",
    province: "北京",
    city: "北京",
    ...
    publicMethod: "查看专题",
    externalUrl: "/national-events",
    summary: "2026年中国魔方运动巡回赛总决赛。",
    description: "2026年中国魔方运动巡回赛暨段级位积分赛总决赛，后续可继续补充成绩与辽宁选手参赛记录。",
    status: "部分整理",
    completeness: "中",
    featured: false
  }
...
function getIsoWeekStartDate(year: number, weekNumber: number) {
  ...
  firstWeekMonday.setUTCDate(fourthOfJanuary.getUTCDate() - dayOfWeek + 1);
  const targetMonday = new Date(firstWeekMonday);
  targetMonday.setUTCDate(firstWeekMonday.getUTCDate() + (weekNumber - 1) * 7);
  return targetMonday.toISOString().slice(0, 10);
}

const weeklyMeetCompetitions: Competition[] = weeklyMeets.map((meet) => {
  const weeklyDate = meet.publishedAt?.slice(0, 10) || getIsoWeekStartDate(meet.year, meet.yearWeek);

  return {
    id: `c-weekly-${meet.slug}`,
    slug: `weekly-${meet.slug}`,
    name: meet.title,
    category: "weekly-meet",
    date: `${weeklyDate}（${meet.dateLabel}）`,
    province: "辽宁",
    city: "沈阳",
    venue: "辽宁魔方少儿战队周赛",
    address: "辽宁省沈阳市（队内周赛）",
    tags: ["周赛", meet.event, meet.dateLabel],
    cover: "/visuals/event-shenyang.svg",
    dataSource: "周赛数据",
    dataSourceUrl: `/weekly/${meet.slug}`,
    publicPlatform: "站内周赛",
    publicMethod: "查看成绩",
    externalUrl: `/weekly/${meet.slug}`,
    summary: meet.summary,
    description: meet.intro.join(" ") || meet.summary,
    status: "已整理",
    completeness: "高",
    featured: meet.weekNumber === weeklyMeets[0]?.weekNumber
  };
});
...
export const competitions: Competition[] = [
  ...
  ...nationalTourCompetitions,
  ...weeklyMeetCompetitions
];
